...
*Breakfast · Main · Vegetarian/Vegan · Nut-Free: Yes (keep nut toppings
...
- 3 cups quick oats (or 6 individual packets)
- 6 cups water or milk (milk is richer; water plus powdered milk works too)
- Pinch of salt
- Brown sugar
- Cinnamon
...
- **Second Class:** counts as the hot breakfast a scout cooks solo (it is
  cooked, not just hot water added).
- **First Class:** works as the hot breakfast in a planned menu; useful
  talking point for grain + fruit + dairy coverage in a quick meal, per the
  current RealFood.gov guidance.
