...
same bowl of batter. Good as a lighter breakfast or paired with a meat side
(bacon, sausage links) that isn't tracked as a separate page here.

## Ingredients (serves 6, 3 pancakes each)

**Base:**
- 3 cups pancake mix (a "just add water/milk" complete mix keeps the
  ingredient list short)
- 2 cups milk
- 2 large eggs (or egg-free swap, see below)
...
- Spatula, mixing bowl, whisk
- Small bowls or cups to keep each mix-in separate at the griddle
...
- Pour syrup into a small squeeze bottle rather than hauling the full jug,
  unless the troop is already bringing one for other meals.
- Portion chocolate chips and cinnamon-sugar into small zip bags at home;
  bananas get sliced at camp, berries just get rinsed.
...
3. Pour 1/4 cup batter per pancake. Ask each scout which mix-in they want,
   then sprinkle it onto the wet batter right after pouring, before any
   bubbles form.
4. Flip when bubbles form across the surface and edges look set, about
   2 minutes a side.
5. Keep finished pancakes covered with foil to stay warm while cooking the
   rest.
...
- **Egg-free swap:** replace the 2 eggs with 2 tbsp ground flaxseed mixed
  with 6 tbsp water, left to sit 5 minutes until gel-like. Pancakes come out
  slightly denser but cook and taste fine. Double-check the pancake mix box
  itself doesn't already contain egg powder.
- **Vegetarian:** yes, as written (no meat).

## Cost Estimate

Base $1.95/scout for 6: mix $3.50, milk $1.20, eggs $0.95, oil/butter
$0.50, syrup $5.50. Mix-ins add roughly $0.60-0.90/scout depending on
...
- **First Class:** works as the hot breakfast in a planned menu.
