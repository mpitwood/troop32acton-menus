...
*Dinner (dessert) · Dessert · Vegetarian · Nut-Free: Yes (check box mix
...
- Decant the oil needed for the batter into a small travel container.
- If using the applesauce egg-free swap, portion it into a small container
  ahead of time.
...
- **Egg-free swap:** replace each egg the box calls for with 1/4 cup
  ...
  which most scouts won't mind for a brownie.
...
- **Patrol of 4:** one box still works, just cut smaller pieces or expect
  seconds.
- **Patrol of 8:** use 1.5-2 boxes and a 14" oven, or bake in two batches.

## Advancement Tie-In

- **Tenderfoot:** assist in preparing this meal.
- **Cooking merit badge:** satisfies the dutch oven method and the
