...
- Yourself + adult (name/relation): ________________________
- Does that adult have any food allergy, intolerance, or diet you need to
  plan around? ________________________________________________
- If yes, how does your plan account for it? ________________________
...
Dessert (one, any day): ________________________
...
## 4. Recipes, shopping list, and cost

For the one breakfast, one lunch, one dinner, and one dessert you'll
actually cook and serve (pick these from your 3-day plan above):

- Recipe source for each (a repo page you adapted, a family recipe, a
  cookbook): ________________________________________________
...
Methods used, checked off (need 5+): ☐ Baking ☐ Boiling ☐ Broiling
☐ Pan frying ☐ Simmering ☐ Microwaving ☐ Air frying ☐ Grilling
☐ Foil cooking ☐ Dutch oven

## 6. Timing and verification

- What's ready last, and what needs to start first so everything lands
  on the table together? ________________________________________________
- Adult verifying your timing (name): ________________________

## 7. Evaluation

- Feedback from whoever you served (presentation, taste): ________________
- Your own evaluation — what worked, what would you change next time?
  ________________________________________________
