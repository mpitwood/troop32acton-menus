...
> the menu includes the foods from MyPlate or the current USDA nutritional
...
- "One of the above campouts" = a real trip counting toward requirement
  1a, not hypothetical.
- Campout: ________________________ Date(s): ________________________
- Trip type: ☐ Front-country (car camping) ☐ Backpacking
- Nights: _____
...
- At least two rows above must be "Yes." If not, swap a No-Cook page for
  a cooked one.

## 3. Check the menu fits everyone going
...
- Real protein source at **every** meal? ________________
- Vegetable or fruit at more than one meal? ________________
- Anything in "Other/processed" doing real nutritional work (cheese
  powder, TVP) vs. just there for taste? ________________

## 5. Does it fit the activity?
