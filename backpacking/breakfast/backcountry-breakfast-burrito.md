...
**Base:**
- 1/2 cup dehydrated refried or black bean flakes (2 oz)
- 2 tbsp TVP (textured vegetable protein) (0.5 oz)
- 1 tbsp dehydrated bell pepper/onion flakes (0.3 oz)
- 3 tbsp cheese powder (0.8 oz)
- Pinch cumin, pinch chili powder
- 1 burrito-size flour tortilla (1.6 oz)
...
- Insulating cozy for the pot (a fleece sleeve or foam wrap) to hold heat
  while the beans rehydrate without extra fuel
...
3. Stir in the cheese powder. Warm the tortilla briefly if you have fuel
   to spare, or use it as-is.
4. **Assemble the vegetarian burrito first**, straight from the shared
   pot. Meat-eating scouts then add dehydrated sausage crumbles to their
   own burrito.
...
[README.md](../README.md#pricing).

## Scaling Notes

- Patrol of 4/8: scales linearly per person.
- Dehydrated components keep well for a 3-night trip with no special
  storage; tortillas hold up for about a week unrefrigerated.

## Advancement Tie-In

- **Tenderfoot:** assist in preparing this meal.
- **Second Class:** counts as a hot meal a scout cooks solo.
- **Cooking merit badge (trail cooking):** a genuine trail-cooked hot
  meal using a boil-and-steep method.
