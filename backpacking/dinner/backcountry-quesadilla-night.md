...
- 2 tortillas (3.2 oz)
- 1 oz cheese powder
- 1 oz dehydrated black bean flakes
- 0.5 oz TVP (textured vegetable protein)
- 0.4 oz dehydrated bell pepper/onion flakes

**Pepperoni boost (sized to meat-eating scouts):**
...
- Portion the cheese powder, bean flakes, TVP, and veggie flakes into one
  bag per person per dinner day.
...
2. Spread the filling on one tortilla, top with a second tortilla to make
   a quesadilla shape.
3. **Build the vegetarian quesadillas first.** For meat-eating scouts,
   add pepperoni to the filling before closing the second tortilla.
4. If you have a pan, warm each quesadilla 1–2 minutes per side over low
   heat until the tortilla crisps slightly. If not, it's still a
   perfectly good folded wrap eaten as-is.
...
- Patrol of 4/8: scales linearly; boost sized to actual meat-eater
  headcount.
- Works with or without a pan, which makes it a good backup dinner if
  the patrol's cookware is minimal that trip.
